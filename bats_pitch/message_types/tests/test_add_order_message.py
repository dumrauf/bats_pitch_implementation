    ...
    def test_symbol_clear_message(self):
        descriptions = [
            ...
            },
            {
                self.OFFSET: 8,
                self.LENGTH: 1,
                self.DATA_TYPE: SingleCharacter(character='A'),
            },
            {
                self.OFFSET: 9,
                self.LENGTH: 12,
        ...
        self._test_message_type(AddOrderMessage, descriptions)
