    ...
    def test_message(self):
        descriptions = [
            ...
            },
            {
                self.OFFSET: 8,
                self.LENGTH: 1,
                self.DATA_TYPE: SingleCharacter(character='I'),
            },
            {
                self.OFFSET: 9,
                self.LENGTH: 8,
        ...
        self._test_message_type(AuctionUpdateMessage, descriptions)
